...
const options = [
    { value: 'Bangda', label: 'Bangda' },
    { value: 'Barracuda', label: 'Barracuda' },
    { value: 'Bhetki', label: 'Bhetki' },
    { value: 'Chapila', label: 'Chapila' },
    { value: 'Chela', label: 'Chela' },
    { value: 'Chitol', label: 'Chitol' },
    { value: 'Eel', label: 'Eel' },
    { value: 'False Pomfret', label: 'False Pomfret' },
    { value: 'Foli', label: 'Foli' },
    { value: 'Grey Mullet', label: 'Grey Mullet' },
    { value: 'Hilsa', label: 'Hilsa' },
    { value: 'Ilish', label: 'Ilish' },
    { value: 'Indian Basa/Pangasius', label: 'Indian Basa/Pangasius' },
    { value: 'Kaatla', label: 'Kaatla' },
    { value: 'Kajili', label: 'Kajili' },
    { value: 'Kajuli', label: 'Kajuli' },
    { value: 'Kalbasua', label: 'Kalbasua' },
    { value: 'Karimeen', label: 'Karimeen' },
    { value: 'Kekda', label: 'Kekda' },
    { value: 'Koi', label: 'Koi' },
    { value: 'Kokila', label: 'Kokila' },
    { value: 'Mackerel', label: 'Mackerel' },
    { value: 'Pabda', label: 'Pabda' },
    { value: 'Phasa', label: 'Phasa' },
    { value: 'Pulasa', label: 'Pulasa' },
    { value: 'Rani', label: 'Rani' },
    { value: 'Rui', label: 'Rui' },
    { value: 'Rupchanda', label: 'Rupchanda' },
    { value: 'Singhara', label: 'Singhara' },
